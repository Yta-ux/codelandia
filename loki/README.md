...
## 🎨 Layout
Link para o design do projeto: [Loki](https://www.figma.com/file/OFPmaR4BYJd7QeChEOzHgL/Desafios---Codelândia-(Copy)?node-id=7539%3A3)
...
- Clone o repositório
    ```bash
    $ git clone https://github.com/Yta-ux/loki.git
    ```
